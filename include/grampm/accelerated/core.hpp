    ...
    namespace accelerated {
        ...
        class MPM_system {
            ...
            protected:
                ...
                box<F> m_g_extents_local;
                std::array<int, dims> m_ngrid_local;
                int m_g_size_local;
            ...
            public:
                ...
                int g_ngridy() const;
                int g_ngridz() const;
                std::array<F, dims> g_mingrid_local() const;
                std::array<F, dims> g_maxgrid_local() const;
                std::array<int, dims> g_ngrid_local() const;
                int g_size_local() const;
                F g_mingridx_local() const;
                F g_mingridy_local() const;
                F g_mingridz_local() const;
                F g_maxgridx_local() const;
                F g_maxgridy_local() const;
                F g_maxgridz_local() const;
                int g_ngridx_local() const;
                int g_ngridy_local() const;
                int g_ngridz_local() const;
                F& p_x(const int i);
                F& p_y(const int i);
                F& p_z(const int i);
                F& p_vx(const int i);
